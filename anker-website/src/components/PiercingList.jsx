...
const PiercingList = () => {
  ...
  const priceList = t("piercingPriceList", {returnObjects: true})
  ...
  return (
      <section className="container mx-auto px-4 py-8">
        <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl text-center font-bold mb-10">{t("piercingPriceList.title")}</h1>
